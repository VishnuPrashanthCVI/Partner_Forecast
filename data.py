...
def make_scores_dict(df):
	...
	score.append([float(i) for i in [4,3,3,2,2,2,2,2,3,3,4]])
	score.append([float(i) for i in [4,3,3,2,2,2,2,2,3,3,4]])
	score.append([float(i) for i in [4,3,3,3,2,2,2,3,3,3,4]])
	score.append([float(i) for i in [4,4,3,3,3,2,2,3,3,3,4]])
	score.append([float(i) for i in [4,4,3,3,3,2,3,3,3,4,4]])
	score.append([float(i) for i in [4,4,3,3,3,3,3,3,3,4,4]])
	score.append([float(i) for i in [4,4,4,3,3,3,3,3,4,4,4]])
	score.append([float(i) for i in [5,4,4,3,3,3,3,3,4,4,5]])
	score.append([float(i) for i in [5,4,4,3,3,3,4,4,4,4,5]])
	score.append([float(i) for i in [5,5,5,3,3,3,4,4,4,4,5]])
	score.append([float(i) for i in [5,5,5,4,3,3,4,4,4,5,5]])
	score.append([float(i) for i in [5,5,5,4,4,3,4,4,5,5,5]])
