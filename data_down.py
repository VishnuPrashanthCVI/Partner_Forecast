...
def create_respondents(YR=[1,2,3,4],Q=[1,2,3,4],n1=401, n=500):
...
def make_scores_dict(df):
	...
	score.append([float(i) for i in [4,3,3,2,2,2,2,2,3,3,3]])
	score.append([float(i) for i in [3,3,3,3,2,2,2,3,3,3,3]])
	score.append([float(i) for i in [3,3,3,3,3,2,2,3,3,3,3]])
	score.append([float(i) for i in [3,3,3,3,3,2,2,3,3,3,3]])
	score.append([float(i) for i in [3,3,3,3,3,2,2,3,3,3,3]])
	score.append([float(i) for i in [3,3,3,3,3,2,2,3,3,3,3]])
	score.append([float(i) for i in [3,3,3,3,2,2,2,3,3,3,3]])
	score.append([float(i) for i in [3,3,3,2,2,2,2,3,3,3,2]])
	score.append([float(i) for i in [3,3,2,2,2,2,2,3,3,2,2]])
	score.append([float(i) for i in [3,3,2,2,2,2,2,2,3,2,2]])
	score.append([float(i) for i in [3,3,2,1,1,1,1,3,3,2,2]])
