...
def dec_tree(dftt,dftp):
	...
	dtr = RandomForestRegressor(n_estimators=25, random_state=71, n_jobs=-1, oob_score = True)
...
def random_forest(xtrain,xtest,ytrain,ytest,dfq2):
	rfc = RandomForestRegressor(n_estimators=100, n_jobs=-1, random_state=71, verbose=True, oob_score = True)
