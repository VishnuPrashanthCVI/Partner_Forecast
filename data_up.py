...
def create_respondents(YR=[1,2,3,4],Q=[1,2,3,4],n1=301, n=400):
...
def make_scores_dict(df):
	...
	score = []
	score.append([float(i) for i in [3,3,2,2,1,1,1,2,2,3,3]])
	score.append([float(i) for i in [3,3,3,2,1,1,1,2,2,3,3]])
	score.append([float(i) for i in [3,3,3,2,2,1,2,2,3,3,3]])
	score.append([float(i) for i in [3,3,3,2,2,2,2,2,3,3,3]])
	score.append([float(i) for i in [4,4,3,2,2,2,2,2,3,4,4]])
	score.append([float(i) for i in [4,4,4,2,2,2,2,2,4,4,4]])
	score.append([float(i) for i in [4,4,4,3,2,2,2,3,4,4,4]])
	score.append([float(i) for i in [4,4,4,3,3,2,3,3,4,4,4]])
	score.append([float(i) for i in [4,4,4,3,3,2,3,4,4,4,4]])
	score.append([float(i) for i in [4,4,4,4,3,3,3,4,4,4,4]])
	score.append([float(i) for i in [5,4,4,4,3,3,3,4,4,4,5]])
	score.append([float(i) for i in [5,5,4,4,3,3,4,4,4,4,5]])
	score.append([float(i) for i in [5,5,4,4,3,3,4,4,4,5,5]])
	score.append([float(i) for i in [5,5,5,4,3,3,4,4,4,5,5]])
	score.append([float(i) for i in [5,5,5,4,4,3,4,4,4,5,5]])
	score.append([float(i) for i in [5,5,5,4,4,4,4,4,5,5,5]])
