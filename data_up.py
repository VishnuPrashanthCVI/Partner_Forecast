...
def make_scores_dict(df):
	...
	score.append([4,4,3,2,2,2,2,2,3,4,4])
	score.append([4,4,4,2,2,2,2,2,4,4,4])
	score.append([4,4,4,3,2,2,2,3,4,4,4])
	score.append([4,4,4,3,3,2,3,3,4,4,4])
	score.append([4,4,4,3,3,2,3,4,4,4,4])
	score.append([4,4,4,4,3,3,3,4,4,4,4])
	score.append([5,4,4,4,3,3,3,4,4,4,5])
	score.append([5,5,4,4,3,3,4,4,4,4,5])
	score.append([5,5,4,4,3,3,4,4,4,5,5])
	score.append([5,5,5,4,3,3,4,4,4,5,5])
	score.append([5,5,5,4,4,3,4,4,4,5,5])
	score.append([5,5,5,4,4,4,4,4,5,5,5])
